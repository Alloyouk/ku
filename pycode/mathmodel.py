...
# 子图1：七鳃鳗雌雄数量+性别比例
plt.subplot(2,2,1)
plt.plot(t[1:], states[:,0], label='七鳃鳗雄性', color='blue')
plt.plot(t[1:], states[:,1], label='七鳃鳗雌性', color='pink')
plt.axvline(x=25, color='gray', linestyle='--', label='资源从匮乏→充足')
plt.title('七鳃鳗种群动态')
plt.legend()
...
plt.plot(t[1:], male_ratio, color='purple')
plt.axhline(y=0.78, color='gray', linestyle=':', label='资源匮乏时雄性比例')
plt.axhline(y=0.56, color='gray', linestyle='--', label='资源充足时雄性比例')
...
# 子图3：宿主种群
plt.subplot(2,2,3)
plt.plot(t[1:], states[:,2], color='green', label='宿主种群')
plt.axvline(x=25, color='gray', linestyle='--')
plt.title('宿主种群数量')
plt.legend()
...
# 子图4：捕食者种群
plt.subplot(2,2,4)
plt.plot(t[1:], states[:,3], color='red', label='捕食者种群')
plt.axvline(x=25, color='gray', linestyle='--')
plt.title('捕食者种群数量')
plt.legend()
...
line_eel, = ax.plot([], [], label='七鳃鳗总数', color='blue')
line_host, = ax.plot([], [], label='宿主', color='green')
line_predator, = ax.plot([], [], label='捕食者', color='red')
ax.axvline(x=25, color='gray', linestyle='--', label='资源切换')
ax.legend()
ax.set_title('生态系统动态变化（资源匮乏→充足）')
